...
sudo scutil --set ComputerName "0xAHAHACuK"
sudo scutil --set HostName "0xAHAHACuK"
sudo scutil --set LocalHostName "0xAHAHACuK"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "0xAHAHACuK"
...
# Enable long hibernation (speeds up entering sleep mode)
...
# Symlink my wallpapers into ~/Pictures folder
